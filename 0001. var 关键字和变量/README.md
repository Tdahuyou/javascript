...
- [4. 📒 思维导图](#4--思维导图)
- [5. 💻 demo - 理解变量和值](#5--demo---理解变量和值)
- [6. 💻 demo - 区分大小写](#6--demo---区分大小写)
- [7. 💻 demo - 变量的声明、赋值](#7--demo---变量的声明赋值)
- [8. 💻 demo - 仅声明未赋值为 undefined](#8--demo---仅声明未赋值为-undefined)
- [9. 💻 demo - 全局变量](#9--demo---全局变量)
- [10. 💻 demo - 使用未声明的变量会报错](#10--demo---使用未声明的变量会报错)
- [11. 💻 demo - 可一次声明多个变量](#11--demo---可一次声明多个变量)
- [12. 💻 demo - 理解“动态”类型](#12--demo---理解动态类型)
- [13. 💻 demo - 变量重复声明无效](#13--demo---变量重复声明无效)
- [14. 💻 demo - 变量重复声明并重新赋值](#14--demo---变量重复声明并重新赋值)
<!-- endregion:toc -->
